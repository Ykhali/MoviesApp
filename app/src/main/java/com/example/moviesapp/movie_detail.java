...
public class movie_detail extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private void fetchMovieDetails(int movieId) {
        String TMDB_API_KEY = "bbbc3cc455c7f44ca0e576721e926a30";
        ...
        JsonObjectRequest movieDetailsRequest = new
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    Glide.with(movie_detail.this).load(imageUrl).into(img);
...
// For example, you can store it in a member variable and use it later to play the trailer
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(movie_detail.this, "Trailer not available", Toast.LENGTH_SHORT).show();
            }
        });
// Add both requests to the RequestQueue
    ...
    private void playTrailer() {
        ...
        if (trailerKey != null && !trailerKey.isEmpty()) {
            ...
            Intent intent = new Intent(movie_detail.this, video_player.class);
